...
<body>
	...
	<section class="breadcrumb-blog set-bg" data-setbg="img/breadcrumb-bg.jpg" id="carosel">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div id="carouselExampleControls" class="carousel slide carousel-fade" data-bs-ride="carousel"
						...
						<div class="carousel-inner">
							<?php $i = 0; foreach($carosel as $aa): ?>
							<div class="carousel-item <?= $i == 0 ? 'active' : '' ?>">
								<img class="img-carosel" src="<?= base_url('assets/upload/Carousel/'.$aa['foto'])?>"
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						...
						<div class="blog__item__text">
							...
							<h4><?= $aa['judul']?></h4>
							<h5>
								Rp. <?= number_format((int)($aa['harga'] ?? 0), 0, ',', '.') ?>
							</h5>
