        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?= base_url(); ?>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">KAYYY</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?php if($menu =='carosel'){  echo "active"; } ?>">
              <a href="<?= site_url('admin/carosel') ?>" class="menu-link">
