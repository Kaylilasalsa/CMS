...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?= base_url('assets/sneat')?>
    ...
    <script sr="<?= base_url('assets/sneat/')?>assets/js/config.js"></script>
  </head>
    ...
    <div class="container-xxl">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="mb-2">Welcome to emira boutique 👋</h4>
